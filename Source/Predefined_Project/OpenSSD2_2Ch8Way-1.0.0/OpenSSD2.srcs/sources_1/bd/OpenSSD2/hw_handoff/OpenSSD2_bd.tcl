...
CONFIG.PCW_USE_S_AXI_HP3 {1}  ] $PS
  ...
  set Tiger4NSC_0 [ create_bd_cell -type ip -vlnv ENCLab:ip:Tiger4NSC:1.2.3 Tiger4NSC_0 ]

  # Create instance: Tiger4NSC_1, and set properties
  set Tiger4NSC_1 [ create_bd_cell -type ip -vlnv ENCLab:ip:Tiger4NSC:1.2.3 Tiger4NSC_1 ]
